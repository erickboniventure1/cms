                    ...
                    <div class="content-box">
                                ...
                                <div class="element-wrapper">
                                    ...
                                    <div class="element-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-xxxl-3">
                                                <a class="element-box el-tablo" href="#">
                                                    <div class="label">Contract due in 30 Days</div>
                                            ...
                                            <div class="col-sm-4 col-xxxl-3">
                                                <a class="element-box el-tablo" href="#">
                                                    ...
                                                    <!-- <div class="trending trending-down-basic"><span>1</span><i class="os-icon os-icon-arrow-down"></i></div> -->
                                                </a>
                                            </div>
                                            <!-- <div class="d-none d-xxxl-block col-xxxl-3">
                                                <a class="element-box el-tablo" href="#">
                                                    ...
                                                    <div class="trending trending-up-basic"><span>6</span><i class="os-icon os-icon-arrow-up2"></i></div>
                                                </a>
                                            </div> -->
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <!-- <div class="col-sm-8 col-xxxl-6">
                                <div class="element-wrapper">
                                    <h6 class="element-header">New Clients</h6>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Clients</h6>
...
-------------------->
                        <div class="element-wrapper">
                            <h6 class="element-header">Contact Person</h6>
                            <div class="element-box-tp">
                                ...
                                <div class="users-list-w">
                                    <div class="user-w with-status status-green">
                                        ...
                                        <div class="user-name">
                                            <h6 class="user-title">Evelyne Maeda</h6>
                                            <div class="user-role">Account Manager CATS NET</div>
                                        </div>
                                    ...
                                    <div class="user-w with-status status-green">
                                        ...
                                        <div class="user-name">
                                            ...
                                            <div class="user-role">Administrator PMI</div>
                                        </div>
                                        <a class="user-action" href="users_profile_small.html">
                                            <div class="os-icon os-icon-email-forward"></div>
                                        </a>
                                    ...
                                    <div class="user-w with-status status-red">
                                        ...
                                        <div class="user-name">
                                            ...
                                            <div class="user-role">HR Manger VODACOM</div>
                                        </div>
                                        <a class="user-action" href="users_profile_small.html">
                                            <div class="os-icon os-icon-email-forward"></div>
                                        </a>
                                    ...
                                    <div class="user-w with-status status-green">
                                        ...
                                        <div class="user-name">
                                            ...
                                            <div class="user-role">Lead Developer OLETECH</div>
                                        </div>
                                        <a class="user-action" href="users_profile_small.html">
                                            <div class="os-icon os-icon-email-forward"></div>
                                        </a>
